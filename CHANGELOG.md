...
## [0.0.5](https://github.com/OxideAV/oxideav-pict/compare/v0.0.4...v0.0.5) - 2026-09-25

### Other

- hostile-input suite for the $8200/$8201 render paths
- straight-blit fast path for identity $8200/$8201 without mask or matte
- real-world $8200 sample pins and compositor benches
- tolerate ImageMagick's PackBits row shape (planar rows as one stream, 1-byte count)
- parse_pict / probe_pict / quicktime_8200 targets
- $8200 rendering, StdPix composition rule and validation numbers
- palette-index colour tables (ctFlags bit 14) index sequentially
- skip the default warning placeholder once a $8200 image draws
- $8200 CompressedQuickTime pixels reach the canvas
- honor device ColorTable indexing
